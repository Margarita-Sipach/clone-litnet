    ...
    <PageWrapper title="Книги">
      <BookElement
        book={{
          ...
          annotation:
            "ddddddddd dddddddddddddd ddddddddddddddddd dddddddddddddddddddddd ddddddddddddddddddddddddddd ddddddddddddddddddddddd dddddddddddddddddddddddd ddddddddddd",
          rating: 5,
        }}
      ></BookElement>
    </PageWrapper>
